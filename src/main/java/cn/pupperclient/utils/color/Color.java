...
import cn.pupperclient.utils.misc.ICopyable;
import cn.pupperclient.utils.misc.ISerializable;
...
public class Color implements ICopyable<Color>, ISerializable<Color> {
    ...
    public Color fromTag(CompoundTag tag) {
        r = tag.getInt("r").orElse(0);
        g = tag.getInt("g").orElse(0);
        b = tag.getInt("b").orElse(0);
        a = tag.getInt("a").orElse(0);
